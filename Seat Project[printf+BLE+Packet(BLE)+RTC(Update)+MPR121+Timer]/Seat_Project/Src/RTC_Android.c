...
//	origin.year = originDate.Year;
//	origin.month = originDate.Month;
//	origin.day = originDate.Date;
//	origin.hour = originTime.Hours;
//	origin.minute = originTime.Minutes;
//	origin.second = originTime.Seconds;
	
	HAL_RTC_GetAlarm(&rtc_android, &originAlarm, 0, RTC_FORMAT_BIN);
	convertRTCToDate(&originDate, &originAlarm.AlarmTime, &origin);
//	alarm.year = originDate.Year;
//	alarm.month = originDate.Month;
//	alarm.day = originDate.Date;
//	alarm.hour = originAlarm.AlarmTime.Hours;
//	alarm.minute = originAlarm.AlarmTime.Minutes;
//	alarm.second = originAlarm.AlarmTime.Seconds;
